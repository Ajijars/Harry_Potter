          ...
          {books.map((book, i) => (
            <Link
              ...
              onMouseEnter={e => {
                ...
                el.style.borderColor = book.accentColor + '80'
                el.style.boxShadow = `0 30px 80px rgba(0,0,0,0.7), 0 0 60px ${book.glowColor}`
              }}
              onMouseLeave={e => {
                const el = e.currentTarget as HTMLElement
            ...
            >
              ...
              <div style={{
                ...
                <span style={{
                  fontSize: '5rem',
                  filter: `drop-shadow(0 0 25px ${book.accentColor})`,
                }}>
                  {book.icon}
                </span>
                {/* Book number overlay */}
